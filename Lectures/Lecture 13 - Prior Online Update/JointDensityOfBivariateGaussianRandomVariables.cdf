...
NotebookDataLength[     82210,       1657]
NotebookOptionsPosition[     54878,       1069]
NotebookOutlinePosition[     81159,       1630]
CellTagsIndexPosition[     81048,       1624]
WindowTitle->Joint Density of Bivariate Gaussian Random Variables
WindowFrame->Normal*)
...
Cell["Joint Density of Bivariate Gaussian Random Variables", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`\[Rho]$$ = 0, $CellContext`\[Sigma]X$$ = 
    1, $CellContext`\[Sigma]Y$$ = 1, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Sigma]X$$], 1, 
       "\!\(\*SubscriptBox[\(\[Sigma]\), \(X\)]\)"}, 0.01, 2}, {{
       Hold[$CellContext`\[Sigma]Y$$], 1, 
       "\!\(\*SubscriptBox[\(\[Sigma]\), \(Y\)]\)"}, 0.01, 2}, {{
       Hold[$CellContext`\[Rho]$$], 0}, -0.99, 0.99}}, Typeset`size$$ = {
    583., {147.5, 152.5}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`\[Sigma]X$26088$$ = 
    0, $CellContext`\[Sigma]Y$26089$$ = 0, $CellContext`\[Rho]$26090$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`\[Rho]$$ = 0, $CellContext`\[Sigma]X$$ = 
        1, $CellContext`\[Sigma]Y$$ = 1}, "ControllerVariables" :> {
        Hold[$CellContext`\[Sigma]X$$, $CellContext`\[Sigma]X$26088$$, 0], 
        Hold[$CellContext`\[Sigma]Y$$, $CellContext`\[Sigma]Y$26089$$, 0], 
        Hold[$CellContext`\[Rho]$$, $CellContext`\[Rho]$26090$$, 0]}, 
      "OtherVariables" :> {
...
\[Sigma]X$$, $CellContext`\[Sigma]Y$$, $CellContext`\[Rho]$$], \
{$CellContext`x, -5, 5}, {$CellContext`y, -5, 5}, AxesLabel -> Automatic, 
           PlotRange -> All, PerformanceGoal -> "Quality", 
           ImageSize -> {300, 300}, ImagePadding -> 20], 
          ContourPlot[
           $CellContext`f[$CellContext`x, $CellContext`y, $CellContext`\
\[Sigma]X$$, $CellContext`\[Sigma]Y$$, $CellContext`\[Rho]$$], \
{$CellContext`x, -5, 5}, {$CellContext`y, -5, 5}, AxesLabel -> Automatic, 
           PlotRange -> All, PerformanceGoal -> "Quality", 
           ImageSize -> {275, 275}]}}], 
      "Specifications" :> {{{$CellContext`\[Sigma]X$$, 1, 
          "\!\(\*SubscriptBox[\(\[Sigma]\), \(X\)]\)"}, 0.01, 
         2}, {{$CellContext`\[Sigma]Y$$, 1, 
          "\!\(\*SubscriptBox[\(\[Sigma]\), \(Y\)]\)"}, 0.01, 
         2}, {{$CellContext`\[Rho]$$, 0}, -0.99, 0.99}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{628., {219., 224.}},
    ...
    Initialization:>(({$CellContext`f[
          ...
          Pattern[$CellContext`\[Rho], 
           Blank[]]] := (1/(2 
          Pi $CellContext`\[Sigma]X $CellContext`\[Sigma]Y 
          Sqrt[1 - $CellContext`\[Rho]^2])) 
         Exp[((-1)/(
            2 (1 - $CellContext`\[Rho]^2))) (($CellContext`x/$CellContext`\
\[Sigma]X)^2 - 
            2 $CellContext`\[Rho] ($CellContext`x/$CellContext`\[Sigma]X) \
($CellContext`y/$CellContext`\[Sigma]Y) + ($CellContext`y/$CellContext`\
\[Sigma]Y)^2)], Attributes[PlotRange] = {ReadProtected}}; 
...
\[Sigma]X)^2 - 
             2 $CellContext`\[Rho] ($CellContext`x/$CellContext`\[Sigma]X) \
($CellContext`y/$CellContext`\[Sigma]Y) + ($CellContext`y/$CellContext`\
\[Sigma]Y)^2)]}]]; Typeset`initDone$$ = True),
...
Cell[TextData[{
 "This Demonstration shows a 3D plot and a plot of a bivariate Gaussian \
(normal) density with zero means. You can drag the sliders for the standard \
deviations ",
 Cell[BoxData[
  FormBox[
...
Cell["Some things to try:", "DetailNotes",
 CellID->2103911148],

Cell["\<\
1. Start with the default variances of 1 and note the effect of changing the \
correlation coefficient. What are the possible angles of the major axis of \
the ellipses you create?\
\>", "DetailNotes",
 CellID->1841831606],

Cell[TextData[{
 "2. Now set the correlation coefficient ",
 Cell[BoxData[
  FormBox["\[Rho]", TraditionalForm]], "InlineMath"],
 " to a value close to ",
 Cell[BoxData[
 ...
 ". Then adjust the standard deviations for the two random variables. What \
are the possible angles of the major axis of the ellipses you create?"
}], "DetailNotes",
 CellID->1257170509],

Cell[TextData[{
 "3. Now set the correlation coefficient ",
 Cell[BoxData[
  FormBox["\[Rho]", TraditionalForm]], "InlineMath"],
 " to a value close to ",
 Cell[BoxData[
...
Cell[TextData[{
 ButtonBox["Correlation Coefficient",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/CorrelationCoefficient.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/CorrelationCoefficient.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Normal Distribution",
  ...
  ButtonNote->"http://mathworld.wolfram.com/NormalDistribution.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
JointDensityOfBivariateGaussianRandomVariables&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
JointDensityOfBivariateGaussianRandomVariables/\
JointDensityOfBivariateGaussianRandomVariables-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Joint Density of Bivariate Gaussian Random Variables",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
JointDensityOfBivariateGaussianRandomVariables/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
JointDensityOfBivariateGaussianRandomVariables/"],
 "\"",
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["John M. Shea",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=John+M.+Shea"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=John+M.+Shea"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40187, 706, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40448, 715, 4829, 105, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54056, 1044, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 80760, 1613},
 {"Copyright", 80956, 1618}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35023, 592, 4621, 95, 70, "Output",
 CellID->164532944],
Cell[39647, 689, 537, 15, 70, "ManipulateCaption"],
Cell[40187, 706, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40448, 715, 4829, 105, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45280, 822, 33, 0, 70, "DetailsSection"],
Cell[45316, 824, 63, 1, 70, "DetailNotes",
 CellID->2103911148],
Cell[45382, 827, 232, 5, 70, "DetailNotes",
 CellID->1841831606],
Cell[45617, 834, 425, 11, 70, "DetailNotes",
 CellID->1257170509],
Cell[46045, 847, 424, 11, 70, "DetailNotes",
 CellID->156075825],
Cell[46472, 860, 44, 0, 70, "RelatedLinksSection"],
Cell[46519, 862, 659, 21, 70, "RelatedLinks",
 CellID->158957328],
Cell[47181, 885, 647, 21, 70, "RelatedLinks",
 CellID->264917757],
Cell[47831, 908, 4881, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[52715, 1001, 45, 0, 70, "CitationSection"],
Cell[52763, 1003, 963, 27, 70, "Citations"],
Cell[53729, 1032, 324, 10, 70, "Author"],
Cell[54056, 1044, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature LQqSfWo98lSYYxA2tf@RprUO *)
